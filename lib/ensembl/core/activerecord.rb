...
#        end
    ...
    class ObjectXref < DBConnection
      ...
      belongs_to :gene, -> { where(ensembl_object_type: 'Gene') },  :class_name => "Gene", :foreign_key => 'ensembl_id'
      belongs_to :transcript, -> { where(ensembl_object_type: 'Transcript') }, :class_name => "Transcript", :foreign_key => 'ensembl_id'
      belongs_to :translation,  -> { where(ensembl_object_type: 'Translation') }, :class_name => "Translation", :foreign_key => 'ensembl_id'
      belongs_to :xref
      has_one :go_xref
    end
